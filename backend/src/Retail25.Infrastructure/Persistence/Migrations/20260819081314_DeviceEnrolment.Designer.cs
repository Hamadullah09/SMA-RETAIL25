...
namespace Retail25.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260819081314_DeviceEnrolment")]
    partial class DeviceEnrolment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Retail25.Domain.Sales.CartLine", b =>
                {
                    ...
                    b.Property<decimal>("UnitWeightSnapshot")
                        .HasPrecision(19, 4)
                        .HasColumnType("decimal(19,4)")
                        .HasColumnName("unit_weight_snapshot");
            ...
            modelBuilder.Entity("Retail25.Domain.Sales.SaleLine", b =>
                {
                    ...
                    b.Property<long?>("RefundsSaleLineId")
                        .HasColumnType("bigint")
                        .HasColumnName("refunds_sale_line_id");
                    ...
                    b.HasIndex("RefundsSaleLineId")
                        .HasDatabaseName("ix_sale_lines_refunds_sale_line_id")
            ...
            modelBuilder.Entity("Retail25.Domain.Shoppers.Shopper", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("NormalizedEmail")
                        .IsUnique()
                        .HasDatabaseName("ix_shoppers_normalized_email");

                    b.HasIndex("Phone")
                        .HasDatabaseName("ix_shoppers_phone");

                    b.ToTable("shoppers", (string)null);
                });

            modelBuilder.Entity("Retail25.Domain.Shoppers.ShopperDevice", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_shopper_devices");

                    b.HasIndex("RefreshTokenHash")
                        .HasDatabaseName("ix_shopper_devices_refresh_token_hash");

                    b.HasIndex("ShopperId", "DeviceId")
                        .IsUnique()
                        .HasDatabaseName("ix_shopper_devices_shopper_id_device_id");

                    b.ToTable("shopper_devices", (string)null);
                });
            ...
            modelBuilder.Entity("Retail25.Domain.Terminals.Device", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("LocalIpAddresses")
                        .HasMaxLength(400)
                        .HasColumnType("nvarchar(400)")
                        .HasColumnName("local_ip_addresses");
                    ...
                    b.HasIndex("LocationId", "DeviceKey")
                        .IsUnique()
                        .HasDatabaseName("ix_devices_location_id_device_key");

                    b.ToTable("devices", (string)null);
                });

            modelBuilder.Entity("Retail25.Domain.Terminals.DeviceEnrolment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("RedeemedByHostname")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)")
                        .HasColumnName("redeemed_by_hostname");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_device_enrolments");

                    b.HasIndex("DeviceId")
                        .HasDatabaseName("ix_device_enrolments_device_id");

                    b.HasIndex("TokenHash")
                        .IsUnique()
                        .HasDatabaseName("ix_device_enrolments_token_hash");

                    b.ToTable("device_enrolments", (string)null);
                });
            ...
            modelBuilder.Entity("Retail25.Domain.Terminals.ReaderAntennaAssignment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_reader_antenna_assignments");

                    b.HasIndex("ReaderId")
                        .HasDatabaseName("ix_reader_antenna_assignments_reader_id");

                    b.HasIndex("StationId")
                        .HasDatabaseName("ix_reader_antenna_assignments_station_id");

                    b.HasIndex("ReaderId", "AntennaNumber")
                        .IsUnique()
                        .HasDatabaseName("ix_reader_antenna_assignments_reader_id_antenna_number");

                    b.ToTable("reader_antenna_assignments", (string)null);
                });
            ...
            modelBuilder.Entity("Retail25.Domain.Terminals.RfidReader", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("DeviceId")
                        .HasDatabaseName("ix_rfid_readers_device_id");

                    b.HasIndex("SerialNumber")
                        .IsUnique()
                        .HasDatabaseName("ix_rfid_readers_serial_number")
                        .HasFilter("[serial_number] IS NOT NULL");

                    b.HasIndex("LocationId", "ReaderKey")
                        .IsUnique()
                        .HasDatabaseName("ix_rfid_readers_location_id_reader_key");
            ...
            modelBuilder.Entity("Retail25.Domain.Trolleys.Trolley", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("StationId")
                        .IsUnique()
                        .HasDatabaseName("ix_trolleys_station_id");

                    b.HasIndex("LocationId", "Code")
                        .IsUnique()
                        .HasDatabaseName("ix_trolleys_location_id_code");

                    b.ToTable("trolleys", (string)null);
                });

            modelBuilder.Entity("Retail25.Domain.Trolleys.TrolleySession", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("TrolleyId")
                        .HasColumnType("bigint")
                        .HasColumnName("trolley_id");

                    b.HasKey("Id")
                        .HasName("pk_trolley_sessions");

                    b.HasIndex("CartId")
                        .HasDatabaseName("ix_trolley_sessions_cart_id");

                    b.HasIndex("ShopperId", "State")
                        .IsUnique()
                        .HasDatabaseName("ix_trolley_sessions_shopper_id_state")
                        .HasFilter("[state] = 'Shopping'");

                    b.HasIndex("State", "LastActivityAt")
                        .HasDatabaseName("ix_trolley_sessions_state_last_activity_at");

                    b.HasIndex("TrolleyId", "State")
                        .IsUnique()
                        .HasDatabaseName("ix_trolley_sessions_trolley_id_state")
                        .HasFilter("[state] = 'Shopping'");

                    b.ToTable("trolley_sessions", (string)null);
                });

            modelBuilder.Entity("Retail25.Infrastructure.Caching.CachedCart", b =>
                {
                    b.Property<long>("CartId")
                        .HasColumnType("bigint")
                        .HasColumnName("cart_id");
                    ...
                    b.HasKey("CartId")
                        .HasName("pk_cached_cart");

                    b.HasIndex("ExpiresAt")
                        .HasDatabaseName("ix_cached_cart_expires_at");

                    b.HasIndex("StationId", "SavedAt")
                        .HasDatabaseName("ix_cached_cart_station_active")
                        .HasFilter("[is_active] = 1");

                    b.ToTable("cached_cart", (string)null);
                });

            modelBuilder.Entity("Retail25.Infrastructure.Caching.CachedHubTicket", b =>
                {
                    ...
                    b.HasKey("Ticket")
                        .HasName("pk_cached_hub_ticket");

                    b.HasIndex("ExpiresAt")
                        .HasDatabaseName("ix_cached_hub_ticket_expires_at");

                    b.ToTable("cached_hub_ticket", (string)null);
                });

            modelBuilder.Entity("Retail25.Infrastructure.Caching.CachedIdempotencyEntry", b =>
                {
                    ...
                    b.HasKey("IdempotencyKey")
                        .HasName("pk_cached_idempotency_entry");

                    b.HasIndex("ExpiresAt")
                        .HasDatabaseName("ix_cached_idempotency_entry_expires_at");

                    b.ToTable("cached_idempotency_entry", (string)null);
                });

            modelBuilder.Entity("Retail25.Infrastructure.Caching.CachedTagClaim", b =>
                {
                    b.Property<string>("Epc")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)")
                    ...
                    b.HasKey("Epc")
                        .HasName("pk_cached_tag_claim");

                    b.HasIndex("ExpiresAt")
                        .HasDatabaseName("ix_cached_tag_claim_expires_at");

                    b.ToTable("cached_tag_claim", (string)null);
                });
            ...
            modelBuilder.Entity("Retail25.Domain.Shoppers.ShopperDevice", b =>
                {
                    b.HasOne("Retail25.Domain.Shoppers.Shopper", null)
                        .WithMany()
                        .HasForeignKey("ShopperId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_shopper_devices_shoppers_shopper_id");
                });

            modelBuilder.Entity("Retail25.Domain.Terminals.DeviceEnrolment", b =>
                {
                    b.HasOne("Retail25.Domain.Terminals.Device", null)
                        .WithMany()
                        .HasForeignKey("DeviceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_device_enrolments_devices_device_id");
                });

            modelBuilder.Entity("Retail25.Domain.Terminals.ReaderAntennaAssignment", b =>
                {
                    b.HasOne("Retail25.Domain.Terminals.RfidReader", null)
                        .WithMany()
                        .HasForeignKey("ReaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_reader_antenna_assignments_rfid_readers_reader_id");

                    b.HasOne("Retail25.Domain.Terminals.Station", null)
                        .WithMany()
                        .HasForeignKey("StationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_reader_antenna_assignments_stations_station_id");
                });
            ...
            modelBuilder.Entity("Retail25.Domain.Terminals.RfidReader", b =>
                {
                    b.HasOne("Retail25.Domain.Terminals.Device", null)
                        ...
                        .HasForeignKey("DeviceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_rfid_readers_devices_device_id");
                });
            ...
            modelBuilder.Entity("Retail25.Domain.Trolleys.Trolley", b =>
                {
                    b.HasOne("Retail25.Domain.Terminals.Station", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_trolleys_stations_station_id");
                });
