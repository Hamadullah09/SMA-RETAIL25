...
public sealed class NumberSequenceTests
{
    ...
    {
        var sequence = NumberSequence.Create(TestIds.Next(), SequenceKind.Invoice, 42, "INV-", 6);
    ...
    {
        var sequence = NumberSequence.Create(TestIds.Next(), SequenceKind.Customer, 4183);
    ...
    {
        var sequence = NumberSequence.Create(TestIds.Next(), SequenceKind.Customer, 4182);
    ...
    {
        var sequence = NumberSequence.Create(TestIds.Next(), SequenceKind.Invoice);
    ...
    {
        var sequence = NumberSequence.Create(TestIds.Next(), SequenceKind.Invoice, 100);
        sequence.Take();
    ...
    {
        var defaults = NumberSequence.SeedDefaults(TestIds.Next());
